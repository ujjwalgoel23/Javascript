...
//random value generator
 ...
 let num=23.1;
 console.log("-----------------");
 console.log(Math.floor(num));//output=>23
 console.log(Math.ceil(num));//output=>24
 ...
 //hme multiply krna hai jitne bhe digit aa rhe ahi uss range hai yha pr 11 se isliye multiply kra hai kyuki 0 bhe included hai toh 0-10 tk 11 digit hote hai
...
//  console.log(Math.random()*10+1).toFixed(1)); // here 1 ka mtlb hai ki ek decimal ka ans degaa
